...
function AdminDashboard({ refreshKey, departments, onViewDepartment, onViewProject, onOpenReviews }) {
  ...
  return <section className="dashboard-page"><div className="dashboard-hero"><div><h1 className="personal-greeting">{timeGreeting(user?.name)}</h1><p className="greeting-subtitle">Here's what's happening across the company today.</p><p className="eyebrow">Company dashboard</p><h2>Operational overview</h2><p>Company-wide workload across every department.</p></div><button className="secondary-button" onClick={onOpenReviews}>View Reviews</button></div>
