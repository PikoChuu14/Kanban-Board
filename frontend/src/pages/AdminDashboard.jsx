...
import { activeTasks, activeWorkload, countStatus, dueLabel, getJson } from "./dashboardUtils";
...
function AdminDashboard({ refreshKey, departments, onViewDepartment, onViewProject, onOpenHistory }) {
  ...
  return <section className="dashboard-page"><div className="dashboard-hero"><div><p className="eyebrow">Company dashboard</p><h1>Operational overview</h1><p>Company-wide workload across every department.</p></div><button className="secondary-button" onClick={onOpenHistory}>View full history</button></div>
