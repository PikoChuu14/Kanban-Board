...
echo WARNING: This replaces the current Kovax FlowOps database data.
choice /m "Continue"
...
pg_restore -h localhost -p 5432 -U kovax_user --clean --if-exists --no-owner -d kovax_flowops "%BACKUP%"
